...
There are three rules for drawing resonance structures.  Resonance structures will differ only in their arrangement of electrons, so their framework must be the same. The second is not to exceed the octet for second period elements.  (It is okay to have fewer than 8 electrons in many cases.)  The final rule is to never break single bonds.  Electrons in the second or third bonds are the most easily moved when drawing contributors.

Resonance typically involves the redistribution of electrons in lone pairs or double (or triple) bonds.  In class, we will look at four patterns to watch for in molecular structures that will clue you in to the presence of resonance.

Take a look at the video below that introduces some of the basic concepts of resonance. 
